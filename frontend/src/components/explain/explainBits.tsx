// Decomposto de ExplainDrawer.tsx (Q.60.AB).
import { useNavigate } from 'react-router-dom';
import { TrendingUp, TrendingDown, AlertTriangle, Ban, Shield, Database, GitBranch, AlertOctagon, CheckCircle, Play, ChevronRight } from 'lucide-react';
...
export type TabId = 'definition' | 'formula' | 'lineage' | 'trust' | 'limitations' | 'improve';

// ═══════════════════════════════════════════════════════════════════════════════
// API FETCH
// ═══════════════════════════════════════════════════════════════════════════════

export async function fetchExplainedMetric(metricId: string): Promise<ExplainedMetric> {
...
// Definition Tab
export function DefinitionTab({ data }: { data: ExplainedMetric }) {
...
// Formula Tab
export function FormulaTab({ data }: { data: ExplainedMetric }) {
  return (
    <div className="space-y-4">
      <div>
...
// Lineage Tab
export function LineageTab({ data }: { data: ExplainedMetric }) {
  return (
    <div className="space-y-4">
      <div>
...
// Trust Tab
export function TrustTab({ data }: { data: ExplainedMetric }) {
...
// Limitations Tab
export function LimitationsTab({ data }: { data: ExplainedMetric }) {
...
// Improve Tab
export function ImproveTab({ data, onSimulate }: { data: ExplainedMetric; onSimulate?: (desc: string) => void }) {
