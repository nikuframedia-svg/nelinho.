...
// Q.173.AI — workforceRisksApi.spof REMOVIDO: endpoint /v1/workforce/risks/spof
// apagado no saneamento (chore/saneamento F1/B, d6937ce) → 404 eterno.
// SpofRiskPanel.tsx e SpofRiskPanel.test.tsx apagados na mesma ocasião.
