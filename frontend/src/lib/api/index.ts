/**
 * ProdPlan ONE — API client: objectos de API por endpoint.
 * ========================================================
 *
 * A infraestrutura partilhada (request/retry/circuit-breaker/headers) vive em
 * ./client.ts. `lib/api` resolve para este index — os ~126 imports de
 * 'lib/api' espalhados pelo frontend não mudam.
 */
import { request, filterParams, API_BASE } from './client';
import type {
...
// Re-export público da infra — 'lib/api' continua a expor estes nomes.
