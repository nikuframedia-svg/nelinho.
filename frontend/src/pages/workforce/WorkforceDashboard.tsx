...
import { Users, AlertTriangle, Network, Play, GraduationCap, Shield, Info, TrendingDown, ArrowRight, RefreshCw, Zap, BarChart3 } from 'lucide-react';
...
import { RiskHeatmap, SPOFAlertPanel, DependencyGraph, WorkforceSimulator, CascadeImpactView, ScenarioComparisonMatrix } from '../../components/workforce';
import type { CascadeImpact, WorkforceDelta, SimulationResult } from '../../components/workforce';
import { transformApiToPhaseRisks, generateSPOFAlertsFromRisks, generateDependencyGraphFromData, generateTrainingRecommendationsFromRisks } from './workforceDashboardData';
