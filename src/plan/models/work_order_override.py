"""Q.116.C — WorkOrderOverride: override manual da data de transporte.
...
`transport_date_override` NULL significa "limpar override"; o endpoint
PATCH .../transport-date aceita None para esse efeito.
...
class WorkOrderOverride(Base):
    """Override manual da data de transporte. PK = work_order_id (INT)."""

    __tablename__ = "work_order_override"
    ...
    transport_date_override: Mapped[Optional[datetime]] = mapped_column(
