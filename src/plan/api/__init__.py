...
from .plan_adherence import router as plan_adherence_router  # Sprint Q.44 (F13)
from .curing_validation import router as curing_validation_router  # Sprint Q.49 (F12)
...
router.include_router(plan_adherence_router)
router.include_router(curing_validation_router)
